...
const soft = [ {
    ...
    "Date" : "2024-04-25",
    "Itname" : "Nandani Kaushal",
    "Iecode" : "E14668",
    "Etname" : "Sharika Sandal",
    "Eecode" : "E16801",
    "block" : "D3",
    "labNo" : 504,
    "capacity" : 36,
    ...
    "Date" : "2024-04-26",
    "Itname" : "Nandini Kaushal",
    "Iecode" : "E14668",
    "Etname" : "Manisha Kaushal",
    "Eecode" : "E16642",
    "block" : "D3",
    "labNo" : 504,
    "capacity" : 36,
    ...
    "Date" : "2024-04-27",
    "Itname" : "Saranjot Kaur",
    "Iecode" : "E13763",
    "Etname" : "Sushiela Khurana",
    "Eecode" : "E15543",
    "block" : "D2",
    "labNo" : 314,
    "capacity" : 36,
...
const softData =[];
soft.forEach(s=>s.Date = new Date(s.Date));
  for(const s of soft){
    softData.push({sectionId:s.id,Ccode:s.code,Cname:s.Cname,IEcode:s.Iecode,ITname:s.Itname,labNo:s.labNo.toString(),block:s.block,capacity:s.capacity.toString(),date: new Date(s.Date),timeSlot: s.timeslot,EEcode:s.Eecode,ETname:s.Etname});
}
    try{
